...
const Avatars = ({ title = "Invitation & Visa Processing - (Report)", showProblemToolbar = true, showCommentToolbar = true, hideControls = false }) => {
  ...
  breadcrumb="My Workspace > Invitation & Visa Processing"
      ...
      {/* pass hideControls so specific worklets can opt-out of selected UI */}
      <RequiredInfo onClick={handleRequiredInfoClick} showProblemToolbar={showProblemToolbar} showCommentToolbar={showCommentToolbar} hideControls={hideControls} />
